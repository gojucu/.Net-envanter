...
namespace Envanter {
    ...
    public partial class EnvanterDataSet : global::System.Data.DataSet {
        ...
        public partial class CategoryDataTable : global::System.Data.TypedTableBase<CategoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CategoryRow AddCategoryRow(string Name, System.DateTime CreateDate, bool isActive) {
...
namespace Envanter.EnvanterDataSetTableAdapters {
    ...
    public partial class CategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Category] WHERE (([ID] = @Original_ID) AND ([Name] = @Original" +
                "_Name) AND ([CreateDate] = @Original_CreateDate) AND ([isActive] = @Original_isA" +
                "ctive))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Category] ([Name], [CreateDate], [isActive]) VALUES (@Name, @C" +
                "reateDate, @isActive);\r\nSELECT ID, Name, CreateDate, isActive FROM Category WHER" +
                "E (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Category] SET [Name] = @Name, [CreateDate] = @CreateDate, [isActive] = @isActive WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([CreateDate] = @Original_CreateDate) AND ([isActive] = @Original_isActive));
SELECT ID, Name, CreateDate, isActive FROM Category WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, CreateDate, isActive FROM dbo.Category";
        ...
        public virtual int Fill(EnvanterDataSet.CategoryDataTable dataTable) {
        ...
        public virtual EnvanterDataSet.CategoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EnvanterDataSet.CategoryDataTable dataTable = new EnvanterDataSet.CategoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EnvanterDataSet.CategoryDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, System.DateTime Original_CreateDate, bool Original_isActive) {
        ...
        public virtual int Insert(string Name, System.DateTime CreateDate, bool isActive) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, System.DateTime CreateDate, bool isActive, int Original_ID, string Original_Name, System.DateTime Original_CreateDate, bool Original_isActive, int ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, System.DateTime CreateDate, bool isActive, int Original_ID, string Original_Name, System.DateTime Original_CreateDate, bool Original_isActive) {
            return this.Update(Name, CreateDate, isActive, Original_ID, Original_Name, Original_CreateDate, Original_isActive, Original_ID);
        }
    }
